 ...
 */
final class Version20220925172850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE restaurant DROP menu_id, DROP ville_id');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE restaurant ADD menu_id INT NOT NULL, ADD ville_id INT DEFAULT NULL');

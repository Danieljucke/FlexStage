...
/**
 * @extends ServiceEntityRepository<CategorieSalle>
 *
...
class CategorieSalleRepository extends ServiceEntityRepository
{
    ...
    public function add(CategorieSalle $entity, bool $flush = false): void
    {
    ...
    public function remove(CategorieSalle $entity, bool $flush = false): void
    {
